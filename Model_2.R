...
for (col in columns) { # nolint
  ...
  # nolint
    ...
    adamModeliETS <- adam(xregExpanded, "MNM", lags=c(1,24,24*7), h=test_set, holdout=TRUE, initial="b",      # nolint
    ...
    write.csv(adamModeliETS_forecast_values, glue("adamModeliETS_forecast_4_{col}.csv"))# nolint
}
