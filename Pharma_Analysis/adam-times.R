...
h2 <- fread("C:/Users/91976/Desktop/hourly-emergency-care-master/data/h2_hourly.csv")
...
# Load Holidays
hols <- as.data.table(read_xlsx("C:/Users/91976/Desktop/hourly-emergency-care-master/data/holiday_rugby.xlsx"))
